    ...
    <main>
      <div className={styles.container}>
        <h2 className={styles.h2}>
          {" "}
          Pour combien de pièces souhaiteriez-vous bénéficier de nos services ?
        </h2>
        ...
        <h2 className={styles.h2}>
          Sélectionnez une date et une heure pour votre premier ménage
        </h2>
